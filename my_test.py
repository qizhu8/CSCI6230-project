...
print("="*40)
bob_DISCON_CLG_info = bob.DISCON_CLG_gen(123)
bob_DISCON_CLG_info_interp = alice.pkg_interp(bob.pkg_gen(bob_DISCON_CLG_info))
print_pkg_info(bob_DISCON_CLG_info_interp)

print("="*40)
bob_DISCON_RPY_info = bob.DISCON_RPY_gen(123)
print(bob.pkg_gen(bob_DISCON_RPY_info))
bob_DISCON_RPY_info_interp = alice.pkg_interp(bob.pkg_gen(bob_DISCON_RPY_info))
